...
hoistedDependencies:
  ...
  /drizzle-kit/0.20.7:
    drizzle-kit: private
  /drizzle-orm/0.29.1(@types/pg@8.10.9)(pg@8.11.3):
    drizzle-orm: private
  ...
  /next-tick/1.1.0:
    next-tick: private
  /next/14.0.4(react-dom@18.0.0)(react@18.0.0):
    next: private
  /node-forge/1.3.1:
    node-forge: private
...
pendingBuilds: []
prunedAt: Wed, 20 Dec 2023 07:38:44 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@rollup/rollup-win32-ia32-msvc/4.9.1
  - /@rollup/rollup-win32-x64-msvc/4.9.1
storeDir: /Users/jacobmckenney/Library/pnpm/store/v3
